      ...
      <div style={{ 
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '10px' }}>
          <tbody>
            ...
            <tr>
              <td><strong>Filtered bookings:</strong></td>
              <td>{filteredBookings.length}</td>
            </tr>
            <tr>
              <td><strong>Current tab:</strong></td>
              <td>{activeTab}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>{error ? 'Error: ' + error : 'None'}</td>
            </tr>
            <tr>
              <td><strong>Cached bookings:</strong></td>
              <td>
                {(() => {
                  try {
                    const cached = localStorage.getItem('userBookings');
                    return cached ? JSON.parse(cached).length + ' items' : 'None';
                  } catch (e) {
            ...
            <tr>
              <td><strong>Last cached:</strong></td>
              <td>
                {localStorage.getItem('lastBookingsFetch') 
                  ? new Date(localStorage.getItem('lastBookingsFetch')).toLocaleString() 
                  : 'Never'}
              </td>
            </tr>
          </tbody>
